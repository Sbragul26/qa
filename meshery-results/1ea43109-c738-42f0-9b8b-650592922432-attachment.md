...
- generic [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e148]:
      ...
      - generic [ref=e593]:
        - img [ref=e594]
        - paragraph [ref=e597]: Generated 33 components for model test-model-1779770150634
        - group [ref=e599]:
  ...
  - dialog [ref=e612]:
    ...
    - generic [ref=e621]:
      ...
      - generic [ref=e713]:
        - paragraph [ref=e714]: "SUMMARY: Imported model test-model-1779770150634 (11 components)"
        - generic [ref=e715]:
          - generic [ref=e716]:
            - paragraph [ref=e717]:
              - generic [ref=e718]: "MODEL:"
              - text: test-model-1779770150634
            - link "Registry" [ref=e719] [cursor=pointer]:
              - /url: settings?settingsCategory=Registry&tab=Models&searchText=test-model-1779770150634
...
```ts
  ...
  3   | 
  4   | // Strongly typed inline to avoid JS linter false positives
  5   | const model: {
  6   |   MODEL_URL: string;
  7   |   MODEL_NAME: string;
  8   |   MODEL_DISPLAY_NAME: string;
  9   | } = {
  10  |   MODEL_URL: 'git://github.com/aws-controllers-k8s/apigatewayv2-controller/main/helm',
  11  |   MODEL_NAME: `test-model-${Date.now()}`,
  12  |   MODEL_DISPLAY_NAME: `Test Model ${Date.now()}`,
  13  | };
  14  | 
  15  | // Strongly typed inline
  16  | const model_import: {
  17  |   MODEL_NAME: string;
  18  |   MODEL_URL_IMPORT: string;
  19  |   MODEL_FILE_IMPORT: string;
  20  |   MODEL_CSV_IMPORT: {
  ...
  27  |   MODEL_NAME: `test`,
  28  |   MODEL_URL_IMPORT:
  29  |     'https://raw.githubusercontent.com/meshery/meshery/master/ui/tests/e2e/assets/test.tar',
  30  |   MODEL_FILE_IMPORT: path.resolve('tests/e2e/assets/test.tar'),
  31  |   MODEL_CSV_IMPORT: {
  32  |     Model_Name: 'couchbase',
  33  |     Models: path.resolve('tests/e2e/assets/models.csv'),
  34  |     Components: path.resolve('tests/e2e/assets/components.csv'),
  35  |     Relationships: path.resolve('tests/e2e/assets/relationships.csv'),
  36  |   },
  37  | };
  38  | 
  39  | test.describe.serial('Model Workflow Tests', () => {
  40  |   test.beforeEach(async ({ page }) => {
  41  |     await page.goto('/settings', { waitUntil: 'domcontentloaded' });
  42  |     await page.waitForURL(/\/settings/);
  43  |     await page.waitForLoadState('networkidle');
  44  |     await expect(page.getByTestId('settings-tab-registry')).toBeVisible();
