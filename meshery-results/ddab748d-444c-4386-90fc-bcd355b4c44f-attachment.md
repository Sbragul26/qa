...
Call log:
  - waiting for getByTestId('header-menu')
      ...
      - generic:
        ...
        - generic [ref=e21]:
          ...
          - generic [ref=e39]:
            ...
            - textbox "I’m having an issue with..." [ref=e64]: "An error occurred on the page at http://localhost:9081/ on 5/13/2026, 12:05:22 AM. Error Details: e?.capabilities?.some is not a function."
          - generic [ref=e66]:
            - generic [ref=e67]:
