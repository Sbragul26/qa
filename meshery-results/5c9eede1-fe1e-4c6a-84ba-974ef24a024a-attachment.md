...
- Name: indexui.spec.ts >> Index Page UI Tests >> Test if Profile button is displayed
- Location: tests/e2e/indexui.spec.ts:20:7
      ...
      - generic:
        ...
        - generic [ref=e21]:
          ...
          - generic [ref=e39]:
            ...
            - textbox "I’m having an issue with..." [ref=e64]: "An error occurred on the page at http://localhost:9081/ on 5/13/2026, 12:58:36 AM. Error Details: e?.capabilities?.some is not a function."
          - generic [ref=e66]:
            - generic [ref=e67]:
