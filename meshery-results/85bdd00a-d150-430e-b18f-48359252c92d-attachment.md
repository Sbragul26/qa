...
- Location: tests/e2e/telemetry.spec.ts:44:7
...
Call log:
  - waiting for getByTestId('Prometheus')
    - locator resolved to <div tabindex="0" role="button" data-testid="Prometheus" class="MuiButtonBase-root MuiListItemButton-root MuiListItemButton-gutters css-1yiucos">…</div>
