  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e192]:
              ...
              - generic:
                ...
                - generic [ref=e271]:
                  ...
                  - generic [ref=e289]:
                    ...
                    - textbox "I’m having an issue with..." [ref=e314]: "An error occurred on the page at http://localhost:9081/management/connections on 5/19/2026, 4:41:45 AM. Error Details: Minified React error #185; visit https://react.dev/errors/185 for the full message or use the non-minified dev environment for full errors and additional helpful warnings.."
                  - generic [ref=e316]:
                    - generic [ref=e317]:
      ...
      - generic:
        ...
        - generic [ref=e354]:
          - img [ref=e355]
          - paragraph [ref=e358]: MeshSync connected in embedded mode
          - group [ref=e360]:
            - button "Open" [ref=e361] [cursor=pointer]:
              - img [ref=e362]
            - button "Close" [ref=e366] [cursor=pointer]:
              - img [ref=e367]
  - alert [ref=e370]: Meshery
```
