...
- Name: performance.spec.js >> Performance Section Tests >> Common UI elements
- Location: tests/e2e/performance.spec.js:28:7
      ...
      - generic:
        ...
        - generic [ref=e21]:
          ...
          - generic [ref=e39]:
            ...
            - textbox "I’m having an issue with..." [ref=e64]: "An error occurred on the page at http://localhost:9081/ on 5/12/2026, 11:46:03 PM. Error Details: e?.capabilities?.some is not a function."
          - generic [ref=e66]:
            - generic [ref=e67]:
