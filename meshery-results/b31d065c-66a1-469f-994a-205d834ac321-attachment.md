      ...
      - generic:
        ...
        - generic [ref=e21]:
          ...
          - generic [ref=e39]:
            ...
            - textbox "I’m having an issue with..." [ref=e64]: "An error occurred on the page at http://localhost:9081/configuration/designs/configurator?design_id=test-design on 5/13/2026, 12:02:47 AM. Error Details: e?.capabilities?.some is not a function."
          - generic [ref=e66]:
            - generic [ref=e67]:
