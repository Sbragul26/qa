...
- Name: telemetry.spec.ts >> Telemetry Section Tests >> Common UI elements
- Location: tests/e2e/telemetry.spec.ts:58:7
...
Call log:
  ...
  - waiting for getByTestId('Grafana')
    ...
    97 × locator resolved to <div tabindex="0" role="button" data-testid="Grafana" class="MuiButtonBase-root MuiListItemButton-root MuiListItemButton-gutters css-12pt0bb">…</div>
