...
- Name: performance.spec.js >> Performance Section Tests >> Configure Metrics Navigation and Settings >> All settings tabs
- Location: tests/e2e/performance.spec.js:43:9
...
Call log:
  - waiting for getByTestId('performance')
      ...
      - generic:
        ...
        - generic [ref=e21]:
          ...
          - generic [ref=e39]:
            ...
            - textbox "I’m having an issue with..." [ref=e64]: "An error occurred on the page at http://localhost:9081/ on 5/13/2026, 12:04:59 AM. Error Details: e?.capabilities?.some is not a function."
          - generic [ref=e66]:
            - generic [ref=e67]:
