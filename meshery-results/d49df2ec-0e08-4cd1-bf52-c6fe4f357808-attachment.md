...
Call log:
  ...
  - attempting click action
    ...
    - retrying click action
      - waiting 100ms
    1133 × waiting for element to be visible, enabled and stable
         - element is visible, enabled and stable
         - scrolling into view if needed
         - done scrolling
         - <p>Generated 33 components for model test-model-1781…</p> from <div id="__next" aria-hidden="true">…</div> subtree intercepts pointer events
...
- generic [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e152]:
      ...
      - generic [ref=e598]:
        - img [ref=e599]
        - paragraph [ref=e602]: Generated 33 components for model test-model-1781551050059
        - group [ref=e604]:
  ...
  - dialog [ref=e617]:
    ...
    - generic [ref=e626]:
      ...
      - generic [ref=e718]:
        - paragraph [ref=e719]: "SUMMARY: Imported model test-model-1781551050059 (11 components)"
        - generic [ref=e720]:
          - generic [ref=e721]:
            - paragraph [ref=e722]:
              - generic [ref=e723]: "MODEL:"
              - text: test-model-1781551050059
            - link "Registry" [ref=e724] [cursor=pointer]:
              - /url: settings?settingsCategory=Registry&tab=Models&searchText=test-model-1781551050059
