...
Call log:
  ...
  - attempting click action
    ...
    - retrying click action
      - waiting 100ms
    398 × waiting for element to be visible, enabled and stable
        - element is visible, enabled and stable
        - scrolling into view if needed
        - done scrolling
        - <p>MeshSync connected in embedded mode</p> from <div id="__next" aria-hidden="true">…</div> subtree intercepts pointer events
...
- generic [ref=e1]:
  ...
  - dialog [ref=e612]:
    ...
    - generic [ref=e621]:
      ...
      - generic [ref=e713]:
        - paragraph [ref=e714]: "SUMMARY: Imported model test-model-1779743717171 (11 components)"
        - generic [ref=e715]:
          - generic [ref=e716]:
            - paragraph [ref=e717]:
              - generic [ref=e718]: "MODEL:"
              - text: test-model-1779743717171
            - link "Registry" [ref=e719] [cursor=pointer]:
              - /url: settings?settingsCategory=Registry&tab=Models&searchText=test-model-1779743717171
