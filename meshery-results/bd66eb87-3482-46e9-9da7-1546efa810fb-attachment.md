...
Call log:
  ...
  - attempting click action
    ...
    - retrying click action
      - waiting 100ms
    1129 × waiting for element to be visible, enabled and stable
         - element is visible, enabled and stable
         - scrolling into view if needed
         - done scrolling
         - <p>Generated 33 components for model test-model-1780…</p> from <div id="__next" aria-hidden="true">…</div> subtree intercepts pointer events
...
- generic [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e152]:
      ...
      - generic [ref=e597]:
        - img [ref=e598]
        - paragraph [ref=e601]: Generated 33 components for model test-model-1780281025213
        - group [ref=e603]:
  ...
  - dialog [ref=e616]:
    ...
    - generic [ref=e625]:
      ...
      - generic [ref=e717]:
        - paragraph [ref=e718]: "SUMMARY: Imported model test-model-1780281025213 (11 components)"
        - generic [ref=e719]:
          - generic [ref=e720]:
            - paragraph [ref=e721]:
              - generic [ref=e722]: "MODEL:"
              - text: test-model-1780281025213
            - link "Registry" [ref=e723] [cursor=pointer]:
              - /url: settings?settingsCategory=Registry&tab=Models&searchText=test-model-1780281025213
