...
Call log:
  - waiting for getByTestId('category-selector')
    - locator resolved to <div labelid="category-selector" inputprops="[object Object]" selectprops="[object Object]" data-testid="category-selector" class="MuiFormControl-root MuiFormControl-fullWidth MuiTextField-root css-1vbfw84">…</div>
