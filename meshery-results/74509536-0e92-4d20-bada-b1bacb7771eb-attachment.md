...
- generic [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e149]:
      ...
      - generic [ref=e207]:
        - main [ref=e208]:
          - generic [ref=e209]:
            ...
            - generic [ref=e227]:
              - generic [ref=e228]: Kanvas Snapshot Helm Plugin
              - paragraph [ref=e229]:
                - img "Helm Chart Logo" [ref=e230]
                - generic [ref=e231]: The Kanvas Snapshot Helm Plugin allows you to generate a visual snapshot of your Helm charts directly from the command line. It simplifies the process of creating Meshery Snapshots, providing a visual representation of packaged Helm charts.
              - button "Learn More" [ref=e233] [cursor=pointer]
            - generic [ref=e235]:
              - generic [ref=e236]: Meshery Docker Extension
              - paragraph [ref=e237]:
                - img "Docker Logo" [ref=e238]
                - generic [ref=e239]: Connect Meshery to your Kubernetes cluster via Docker Desktop and let MeshSync discover your clusters. Use Kanvas's no-code designer to collaboratively design and manage your infrastructure with ready-made patterns from Meshery Catalog.
            ...
            - generic [ref=e259]:
              - generic [ref=e260]: Kubectl Plugin for Kanvas Snapshot
              - paragraph [ref=e261]:
                - img "Kubectl Plugin Logo" [ref=e262]
                - generic [ref=e263]: Generate visual snapshots of your Kubernetes manifests directly from kubectl. Cluster configurations and workflows with Kanvas Snapshots. Receive snapshots via email or get instant terminal URL display.
      ...
      - generic [ref=e437]:
        - img [ref=e438]
        - paragraph [ref=e441]: MeshSync connected in embedded mode
        - group [ref=e443]:
          - button "Open" [ref=e444] [cursor=pointer]:
            - img [ref=e445]
          - button "Close" [ref=e449] [cursor=pointer]:
            - img [ref=e450]
  - alert [ref=e453]: Extensions | Meshery
```
