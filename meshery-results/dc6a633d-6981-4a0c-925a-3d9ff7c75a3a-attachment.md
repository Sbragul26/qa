  ...
  - dialog [ref=e631]:
      ...
      - group [ref=e645]:
        - radiogroup [ref=e646]:
          ...
          - generic [ref=e648] [cursor=pointer]:
            - generic [ref=e649]:
              - radio "File Import Upload a model file (.tar, .tar.gz, .tgz) from your local system" [checked] [active] [ref=e650]
              - generic [ref=e651]:
                - img [ref=e652]
                - img [ref=e654]
            - generic [ref=e657]:
    ...
    - generic [ref=e693]:
      ...
      - generic [ref=e697]:
        ...
        - button "Next" [ref=e699] [cursor=pointer]
```