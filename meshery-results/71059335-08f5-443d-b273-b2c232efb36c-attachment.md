...
- generic [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e201]:
      ...
      - alert [ref=e284]:
        - generic [ref=e285]: Operation succeeded but failed to update the status of the connection to not found.
        - group [ref=e287]:
          - button "Open" [ref=e288] [cursor=pointer]:
            - img [ref=e289]
          - button "Close" [ref=e293] [cursor=pointer]:
            - img [ref=e294]
  - alert [ref=e297]: Meshery
```
