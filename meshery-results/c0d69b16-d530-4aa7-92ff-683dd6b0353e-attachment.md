...
Call log:
  ...
  - attempting click action
    ...
    - retrying click action
      - waiting 100ms
    1120 × waiting for element to be visible, enabled and stable
         - element is visible, enabled and stable
         - scrolling into view if needed
         - done scrolling
         - <p>Generated 33 components for model test-model-1780…</p> from <div id="__next" aria-hidden="true">…</div> subtree intercepts pointer events
...
- generic [ref=e1]:
            ...
            - generic [ref=e143]:
              ...
              - generic [ref=e148]:
                ...
                - link [ref=e149] [cursor=pointer]:
                  - /url: https://docs.meshery.io/project/releases/v1.0.40
                  - img [ref=e150]
    - generic [ref=e152]:
      - banner [ref=e153]:
        - generic [ref=e155]:
      ...
      - generic [ref=e597]:
        - img [ref=e598]
        - paragraph [ref=e601]: Generated 33 components for model test-model-1780975140134
        - group [ref=e603]:
  ...
  - dialog [ref=e616]:
    ...
    - generic [ref=e625]:
      ...
      - generic [ref=e717]:
        - paragraph [ref=e718]: "SUMMARY: Imported model test-model-1780975140134 (11 components)"
        - generic [ref=e719]:
          - generic [ref=e720]:
            - paragraph [ref=e721]:
              - generic [ref=e722]: "MODEL:"
              - text: test-model-1780975140134
            - link "Registry" [ref=e723] [cursor=pointer]:
              - /url: settings?settingsCategory=Registry&tab=Models&searchText=test-model-1780975140134
